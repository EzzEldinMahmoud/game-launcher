...
import { Search, Gamepad2, X, Heart, Download, Plus, Clock, FolderOpen, ChevronDown, Check, Trash2, ChevronRight } from "lucide-react";
...
function CollectionDetail({ collection, games, favourites, onBack, onOpenGame, onToggleFav, onDelete }: {
  collection: Collection;
  games: Game[];
